...
widget3_change_color_button = tk.Button(widget3frame, bg="#0099ff", text="Change Color", font=("Arial", 25), command=change_UI_color)
widget3_color_entryfield = tk.Entry(widget3frame, font=("Arial", 25))

widget3_title.grid(row=0, column=0)
widget3_change_color_button.grid(row=1,column=0, ipady=25, ipadx=50)
